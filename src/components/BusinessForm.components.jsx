...
export function BusinessForm({ onSubmit, onClose }) {
            ...
            <AccordionDetails>
              <Grid container spacing={3}>
               ...
               <Grid size={{md:6,sm:12,xs:12}}>
                ...
                <Grid size={{md:6,sm:12,xs:12}}>
                  <FormControl fullWidth error={!!errors.yearEstablished}>
                    ...
                    {errors.yearEstablished && <Typography variant="caption" color="error">{errors.yearEstablished}</Typography>}
                  </FormControl>
                </Grid>
